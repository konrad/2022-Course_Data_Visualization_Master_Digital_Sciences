...
* Colors and color maps
    ...
    #+CAPTION: Context matters (by Ware)
    #+NAME: fig:Encoding
    #+ATTR_HTML: :width 500
    [[./images/gray_box_on_differen_background.png]]
    ...
    #+CAPTION: [[https://commons.wikimedia.org/wiki/File:World_map_of_total_confirmed_COVID-19_cases_per_million_people.png][Source]]
    #+NAME: fig:Encoding
    #+ATTR_HTML: :width 500
